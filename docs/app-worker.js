const cacheName = "app-" + "971fe606daa360a987495444dfa32d554989ba77";
...
self.addEventListener("install", (event) => {
  console.log("installing app worker 971fe606daa360a987495444dfa32d554989ba77");
...
self.addEventListener("activate", (event) => {
  ...
  console.log("app worker 971fe606daa360a987495444dfa32d554989ba77 is activated");
});
