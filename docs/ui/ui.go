		...
		app.Table().Body(
			app.Tr().Body(
				app.Div().Body(
					...
					app.Br(),
					app.Br(),
					app.Text("Über den Links kommt man zu der Datei mit den Roh-Daten, das kann helfen die genaue Position des Eintrages im Kirchenbuch zu finden."),
					app.Br(),
					...
					app.Br(),
					app.Label().Text("Trauungen Leubitz bis 1799"),
					app.Br(),
