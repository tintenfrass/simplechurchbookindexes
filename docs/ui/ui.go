		...
		app.Table().Body(
			app.Tr().Body(
				app.Div().Body(
					...
					app.Br(),
					app.H3().Body().Text(" v1.1 (Juni 2023) latest updates:"),
					app.Label().Text("Trauungen linke Elbseite 1778-1788"),
					app.Br(),
					app.Label().Text("Trauungen rechte Elbseite 1778-1788"),
					app.Br(),
					app.Label().Text("Trauungen Dresden 1778-1788"),
					app.Br(),
					app.Label().Text("Trauungen linke Elbseite 1767-1777"),
					app.Br(),
					...
					app.Br(),
					app.Label().Text("Trauungen rechte Elbseite 1750-1766"),
					app.Br(),
