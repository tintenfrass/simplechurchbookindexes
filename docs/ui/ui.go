		...
		app.Table().Body(
			app.Tr().Body(
				app.Div().Body(
					...
					app.Br(),
					app.Br(),
					app.Text("Manchmal kommt es vor, dass man einen gefundenen Treffer im Kirchenbuch selber nicht finden."),
					app.Br(),
					...
					app.Br(),
					app.Text("Es gibt auch immer mal wieder Fehler in den Daten, falsche erfasste Namen oder manchmal ist das Jahr um 1 verrutscht, etc."),
					app.Br(),
					app.Br(),
